...
Cam.prototype._passwordDigest = function() {
	...
	nonce.writeUInt32LE(Math.ceil(Math.random() * 0x100000000), 0);
	nonce.writeUInt32LE(Math.ceil(Math.random() * 0x100000000), 4);
	nonce.writeUInt32LE(Math.ceil(Math.random() * 0x100000000), 8);
	nonce.writeUInt32LE(Math.ceil(Math.random() * 0x100000000), 12);
